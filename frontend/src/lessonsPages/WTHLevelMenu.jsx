...
const levels = [
  ...
  { number: 2, status: "Completed", description: "New Words Added:" },
  { number: 3, status: "Ongoing", description: "New Words Added:" },
  { number: 4, status: "Locked", description: "New Words Added:" },
];
...
function WTHLevelMenu() {
  ...
  const handleLevelClick = (levelNum) => {
    ...
    navigate('/words-to-text', { state: { questions: selectedLevel } });
  };
